...
namespace SME.SERAp.Boletim.Dados.Repositorios.Serap
{
    public class RepositorioBoletimProvaAluno : RepositorioBase<BoletimProvaAluno>, IRepositorioBoletimProvaAluno
    {
        ...
        public async Task<(IEnumerable<ResultadoProbabilidadeDto>, int)> ObterResultadoProbabilidadePorUeAsync(long loteId, long ueId, long disciplinaId, int anoEscolar, FiltroBoletimResultadoProbabilidadeDto filtros)
        {
            using var conn = ObterConexaoLeitura();
            try
            {
        ...
        public async Task<IEnumerable<NivelProficienciaDto>> ObterNiveisProficienciaDisciplinas(int anoEscolar, long loteId)
        {
            using var conn = ObterConexaoLeitura();
            try
            {
                ...
                return await conn.QueryAsync<NivelProficienciaDto>(query, new { anoEscolar, loteId });
            }
            finally
            {
                conn.Close();
        ...
        public async Task<IEnumerable<OpcaoFiltroDto<int>>> ObterComponentesCurricularesSmePorAno(int anoAplicacao)
        {
            using var conn = ObterConexaoLeitura();
            try
            {
                ...
                return await conn.QueryAsync<OpcaoFiltroDto<int>>(query, new { anoAplicacao });
            }
            finally
            {
                conn.Close();
        ...
        public async Task<IEnumerable<OpcaoFiltroDto<int>>> ObterAnosEscolaresPorSmeAnoAplicacao(int anoAplicacao, int disciplinaId)
        {
            using var conn = ObterConexaoLeitura();
            try
            {
                ...
                return await conn.QueryAsync<OpcaoFiltroDto<int>>(query, new { anoAplicacao, disciplinaId });
            }
            finally
            {
                conn.Close();
