...
namespace SME.SERAp.Boletim.Dados.Repositorios.Serap
{
    public class RepositorioBoletimEscolar : RepositorioBase<BoletimEscolar>, IRepositorioBoletimEscolar
    {
        ...
        public async Task<IEnumerable<UeProficienciaQueryResultDto>> ObterProficienciaUeProvaSaberesAsync(int dreId, int disciplinaId, int anoLetivo, int anoEscolar, int? ueId = null)
        {
            using var conn = ObterConexaoLeitura();
            try
            {
                ...
                return await conn.QueryAsync<UeProficienciaQueryResultDto>(query.ToString(), parametros);
            }
            finally
            {
                conn.Close();
        ...
        public async Task<IEnumerable<UeProficienciaQueryResultDto>> ObterProficienciaUeProvaSPAsync(int dreId, int disciplinaId, int anoLetivo, int anoEscolar, int? ueId = null)
        {
            using var conn = ObterConexaoLeitura();
            try
            {
                var query = new StringBuilder(@"
                                                ...
                                                JOIN
                                                    ue u ON u.ue_id = apsp.ue_codigo
                                                JOIN
        ...
        public async Task<IEnumerable<ResultadoProeficienciaPorDre>> ObterProficienciasPorSmeProvaSPAsync(int anoLetivo, int disciplinaId, int anoEscolar)
        {
            using var conn = ObterConexaoLeitura();
            try
            {
        ...
        public async Task<IEnumerable<ResultadoProeficienciaPorDre>> ObterProficienciaPorSmeProvaSaberesAsync(int anoLetivo, int disciplinaId, int anoEscolar)
        {
            using var conn = ObterConexaoLeitura();
