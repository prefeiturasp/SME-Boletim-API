...
{
    public class ObterComponentesCurricularesPorDreAnoUseCase : IObterComponentesCurricularesPorDreAnoUseCase
    {
        private readonly IMediator mediator;
        public ObterComponentesCurricularesPorDreAnoUseCase(IMediator mediator)
        {
            this.mediator = mediator;
        }

        public async Task<IEnumerable<OpcaoFiltroDto<int>>> Executar(long dreId, int anoAplicacao)
        {
            ...
            return await mediator.Send(new ObterComponentesCurricularesPorDreAnoQuery(dreId, anoAplicacao));
        }
    }
}
