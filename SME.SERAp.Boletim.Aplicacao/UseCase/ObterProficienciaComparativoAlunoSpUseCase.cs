...
namespace SME.SERAp.Boletim.Aplicacao.UseCase
{
    public class ObterProficienciaComparativoAlunoSpUseCase : IObterProficienciaComparativoAlunoSpUseCase
    {
        ...
        public async Task<ProficienciaComparativoAlunoSpDto> Executar(int ueId, int disciplinaId, int anoEscolar, string turma, int anoCriacao, int pagina, int itensPorPagina)
        {
            ...
            return await mediator.Send(new ObterProficienciaComparativoAlunoSpQuery(ueId, disciplinaId, anoEscolar, turma, anoCriacao, pagina, itensPorPagina));
        }
    }
}