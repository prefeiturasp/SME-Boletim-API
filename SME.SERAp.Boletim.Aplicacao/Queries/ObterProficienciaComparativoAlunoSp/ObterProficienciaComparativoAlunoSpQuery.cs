...
namespace SME.SERAp.Boletim.Aplicacao.Queries.ObterProficienciaComparativoAlunoSp
{
    ...
    {
        public ObterProficienciaComparativoAlunoSpQuery(int ueId, int disciplinaId, int anoEscolar, string turma, long loteId, List<int>? tiposVariacao, string? nomeAluno, int? pagina, int? itensPorPagina)
        {
            UeId = ueId;
